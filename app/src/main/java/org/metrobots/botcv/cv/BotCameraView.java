...
public class BotCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {

    private static final int MAGIC_TEXTURE_ID = 10;
    private static final String TAG = "BotCameraView";
    ...
    public BotCameraView(Context context, int cameraId) {
        super(context, cameraId);
    }

    public BotCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
        ...
        synchronized (this) {
            ...
            if (mCameraIndex == CAMERA_ID_ANY) {
                ...
                try {
                    ...
                    for (int i = 0; i < params.getSupportedPreviewFormats().toArray().length; i++)
                    Log.i("preview format", params.getSupportedPreviewFormats().get(i) + "");
                    linenum = 100;
                    linenum = 103;
                    ...
                    String lenth = "supported sizes: ";
                    for (int i = 0; i<params.getSupportedPreviewSizes().toArray().length; i++) {
                        lenth += params.getSupportedPreviewSizes().get(i).width + "x" + params.getSupportedPreviewSizes().get(i).height + ", ";
                    }
                    Log.i("sup", lenth);
                    ...
                    params.setAntibanding(Parameters.ANTIBANDING_50HZ);
                    ...
                    Log.e(TAG, linenum + "Camera is not available (in use or does not exist): " + e.getLocalizedMessage());
                }
            ...
            try {
                ...
                if (sizes != null) {
                    ...
                    System.out.println("Min exposure compensation: " + params.getMinExposureCompensation());
    ...
    private void orientCamera() {
        ...
        setCameraOrientation(mCamera, -180);
        //setCameraOrientation(mCamera, -90);
        //System.out.println("oriented camera");
    }

    public void setCameraOrientation(Camera camera, int angle) {
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                ...
                synchronized (BotCameraView.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            BotCameraView.this.wait();
                        }
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
